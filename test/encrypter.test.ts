...
describe('Encrypter', () => {
    it('should encrypt stuff', async () => {
        ...
        let seedqb64b = new Matter({ raw: seed, code: MtrDex.Ed25519_Seed })
            .qb64b;
        ...
        let prikey = libsodium.crypto_sign_ed25519_sk_to_curve25519(
            keypair.privateKey
        );
